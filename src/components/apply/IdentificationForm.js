...
const IdentificationForm = ({namePrefix}) => (
  <Card style={{...cardStyle, paddingTop: 25}}>
    <Row>
      <Col>
        <Row>
          <StyledTextField label ='Name' hintText='First Name' name={`${namePrefix}.firstName`} width={314} required />
          <StyledTextField
          ...
          />
          <StyledTextField hintText='Last Name' name={`${namePrefix}.lastName`} width={351}/>
        </Row>
        <Row>
          <StyledTextField
