import { stripPhoneNumber } from './form_normalizers';
...
export const validateZipCode = value => value && value.length == 5 ? undefined : 'You must supply a valid 5-digit zip code.';
